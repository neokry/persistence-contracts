...
contract SequentialInteractorTest is Test, FixedPriceTokenUtils {
    address interactor;
    ...
    function test_interactNoData() public {
        init();
    ...
    function testFork_interactSingle() public {
        ...
        bytes memory interactionData = bytes(
            "Test message Test messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messagTest messag"
        );
        ...
        emit log("sequential interaction");
        (bytes memory data, ) = IInteractor(interactor).getInteractionData(
            address(token),
            0
        );
    ...
    function init() private {
        ...
        interactor = address(new SequentialInteractor());
        vm.prank(owner);
